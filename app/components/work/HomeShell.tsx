  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-3 py-2.5 border-t border-white/10">
        ...
        <Globe className="h-3.5 w-3.5 text-white hover:animate-none animate-[spin_3s_linear_infinite]" />
      </div>
      {/* Account Switcher */}
      ...
      <div className="flex flex-col w-full  gap-2 border-y border-white/20 px-3 py-2.5">
        ...
        <a
          ...
          className="mt-1 w-fit px-2 rounded-full uppercase font-mono py-1 lime text-xs text-black transition"
        >
          <span className="cursor-pointer underlin">Submit</span>
        </a>
      </div>
      {/* Bug report */}
      <div className="flex hidden flex-col px-3 py-2.5">
        <div className="mono flex flex-col gap-1 text-xs tracking-tight text-white">
