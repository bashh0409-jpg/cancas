...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    answer:
      "Credits are the currency for AI actions inside Reflow — generating images, running agents, transforming canvas content, and more. Each action costs a set number of credits. Your credits reset monthly on your billing date, and unused credits don't roll over.",
  },
  {
  ...
  {
    question: "Which AI models does Reflow use?",
    answer:
      "Reflow uses a mix of models depending on the task — image generation, code, reasoning, and multimodal understanding each draw from the best available model for that job. Pro and Ultra plans unlock access to premium reasoning models and faster processing queues.",
  },
  {
