      ...
      <div className="flex w-full flex-col items-center justify-center px-6 lg:max-w-[480px]">
        <div className="flex w-full max-w-[360px] flex-col items-center gap-4">
          ...
          <a
            ...
            className="inline-flex h-[40px] w-full items-center justify-center gap-3 rounded-lg gray px-4 text-sm font-semibold tracking-tight text-black transition-all hover:bg-zinc-200"
          >
            <svg
              width="20"
              height="20"
